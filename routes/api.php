...
Route::group(['middleware' => ['role:super-admin']], function () {
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::put('strategic-initiative-update/{id}', [StrategicInitiativeController::class, 'update']);
        ...
        Route::put('countries-update/{id}', [CountriesController::class, 'update']);
        ...
        Route::put('transaction-type-update/{id}', [TransactionTypeController::class, 'update']);
        ...
        Route::put('ams-update/{id}', [AMSController::class, 'update']);
        ...
        Route::put('prospect-type-update/{id}', [ProspectTypeController::class, 'update']);
