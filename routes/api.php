...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::post('customer-create', 'create')->middleware(['permission:create_customer']);
        Route::get('customer-show/{id}', 'show')->middleware(['permission:show_customer']);
        Route::put('customer-update/{id}', 'update')->middleware(['permission:update_customer']);
        Route::delete('customer-delete/{id}', 'destroy')->middleware(['permission:delete_customer']);
    });
    ...
    Route::controller(SalesController::class)->group(function () {
        ...
        Route::post('sales-request-cogs', 'requestCOGS')->middleware(['permission:request_cogs']);
